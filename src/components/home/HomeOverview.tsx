...
export const HomeOverview: React.FC<HomeOverviewProps> = ({
  ...
  const financialMetrics = useMemo(() => {
    return {
      ...
      tdsAmount: activeSellerMetrics.tdsAmount ?? +((activeSellerMetrics.grossSales / 1.18) * 0.01).toFixed(1),
      tcsAmount: activeSellerMetrics.tcsAmount ?? +((activeSellerMetrics.grossSales / 1.18) * 0.005).toFixed(1),
      totalTaxDeductions: activeSellerMetrics.totalTaxDeductions ?? +((activeSellerMetrics.grossSales / 1.18) * 0.015).toFixed(1),
      netPayoutAfterTdsTcs: activeSellerMetrics.netPayoutAfterTdsTcs ?? +(activeSellerMetrics.grossSales - activeSellerMetrics.commissionFee - ((activeSellerMetrics.grossSales / 1.18) * 0.015)).toFixed(1),
